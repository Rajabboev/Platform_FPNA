"""SQL Server data source extractor"""
import pandas as pd
...
class SQLServerExtractor(DataSourceExtractor):
    ...
    def __init__(
        ...
        self.schema_name = schema_name or "dbo"
    ...
    def extract(self, limit: Optional[int] = None) -> pd.DataFrame:
        ...
        try:
            ...
            raise ExtractionError(f"Failed to extract data from SQL Server: {str(e)}")
